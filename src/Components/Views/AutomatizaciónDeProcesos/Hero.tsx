                    ...
                    return (
                        <div key={index} className='pb-7'>
                            ...
                            {item.innerData.map((newItem, idx) => {
                                return (
                                    <div className='max-w-[618px] mx-auto pb-3'
                                        key={idx}>
                                        <p className='pb-1 text-base font-bold text-[#3D8095]'>{newItem.heading}</p>
                                        <p className='pb-2 text-base font-normal text-[#646467]'>{newItem.text}</p>
                                        <ul>{newItem.list?.map((listItem, idex2) => {
                                            return (
                                                <li className=' list-disc ml-3 pb-1 text-base font-normal text-[#646467]'
                                                    key={idex2}>{listItem}</li>
                                            )
                                        })}</ul>
                                    </div>
                                )
